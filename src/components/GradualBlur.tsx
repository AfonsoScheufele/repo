...
const mergeConfigs = (...configs: Array<Partial<Config> | GradualBlurProps>): Config => {
...
const useResponsiveDimension = (
  ...
  useEffect(() => {
    ...
    const calc = () => {
      ...
      const mobileKey = `mobile${capitalized}` as keyof Config;
      const tabletKey = `tablet${capitalized}` as keyof Config;
      const desktopKey = `desktop${capitalized}` as keyof Config;
